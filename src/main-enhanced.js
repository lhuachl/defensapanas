// Index Principal: Enhanced Presentation Manager con GSAP y efectos parallax
...
class AdvancedPresentationManager {
  ...
  init() {
    ...
    console.log('🎬 Advanced Presentation Manager - Index Principal initialized');
  }
  ...
  initializeSlideElements(slide, slideIndex) {
    const elements = slide.querySelectorAll('.slide-title, .function-card, .value-item, .stage-card, .chapter-card, .definition-main');
  ...
  createParallaxLayers() {
    ...
    // Capa de efectos de luz dinámicos
  ...
  createControlPanel() {
    ...
    controlPanel.innerHTML = `
      ...
      <div class="info-panel">
        <span>Presiona R para efectos aleatorios, P para auto-play, F para pantalla completa</span>
      </div>
    `;
  ...
  handleMouseMove(e) {
    ...
    const parallaxElements = document.querySelectorAll('.function-card, .value-item, .stage-card, .next-chapter-card');
  ...
  colorWaveEffect() {
    const elements = document.querySelectorAll('.function-card, .value-item, .stage-card, .next-chapter-card');
  ...
  rotationEffect() {
    const cards = document.querySelectorAll('.function-card, .value-item, .stage-card');
  ...
  toggleParallax() {
    ...
    if (!this.effectsEnabled) {
      // Resetear posiciones
      gsap.to('.function-card, .value-item, .stage-card, .next-chapter-card', {
        x: 0,
        y: 0,
        rotationX: 0,
        rotationY: 0,
